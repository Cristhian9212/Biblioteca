...
@Composable
fun AutoresScreen(onOptionClick: (String) -> Unit, onBackClick: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(
        ...
        Box(
            ...
            Icon(
                imageVector = Icons.Filled.AccountCircle, // Ícono grande
                contentDescription = "Agregar Autor",
        ...
        Row(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                Button(
                    onClick = { onOptionClick("Agregar Autor") },
                    modifier = Modifier
            ...
            // Botón "Listar Autores"
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                Button(
                    onClick = { onOptionClick("Listar Autores") },
                    modifier = Modifier
                        .size(100.dp) // Tamaño fijo para el botón
                        .padding(16.dp), // Espaciado alrededor del botón
                    colors = ButtonDefaults.buttonColors(
